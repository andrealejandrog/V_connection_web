  ...
  return (
    <div className={styles.camerasContainer}>
      ...
      <section className={styles.heroSection}>
        <h1 className={styles.heroTitle}>{t('cameras', 'heroTitle')}</h1>
      ...
      <section className={styles.contentSection}>
        <div className={styles.feature}>
          ...
          <h4 className={styles.featureTitle}>{t('cameras', 'featureTitle')}</h4>
          <p className={styles.featureSubtitle}>{t('cameras', 'featureSubtitle')}</p>
          <p className={styles.featureText}>
            {t('cameras', 'featureText')}
          </p>
        </div>
        ...
        <div className={styles.featuresGrid}>
          <div className={styles.featureCard}>
            <h6 className={styles.cardTitle}>{t('cameras', 'featureCard1Title')}</h6>
            <p className={styles.cardText}>
              {t('cameras', 'featureCard1Text')}
            </p>
          </div>

          <div className={styles.featureCard}>
            <h6 className={styles.cardTitle}>{t('cameras', 'featureCard2Title')}</h6>
            <p className={styles.cardText}>
              {t('cameras', 'featureCard2Text')}
            </p>
          </div>

          <div className={styles.featureCard}>
            <h6 className={styles.cardTitle}>{t('cameras', 'featureCard3Title')}</h6>
            <p className={styles.cardText}>
              {t('cameras', 'featureCard3Text')}
            </p>
          </div>
        </div>
        ...
        <div className={styles.demoSection}>
          <h2 className={styles.demoTitle}>{t('cameras', 'demoTitle')}</h2>
          <div className={styles.videoContainer}>
            <iframe 
              src="https://www.youtube.com/embed/1869zw6_R5Y" 
              title={t('cameras', 'demoTitle')}
